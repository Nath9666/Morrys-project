...
const CurrentProject = (props) => {
    ...
    const modifIcon = (nameEdit, valueEdit, idIcon, idElToFocus) => {
        return <img src={valueEdit ? ValidationIcon: EditElementIcon}
             className="icon_edit"
             id={idIcon}
             alt={"Modify Item"}
             onClick={() => {setEdit({...edit, [nameEdit]: !valueEdit})
    ...
    return<>
        <div className="Element_and_ModifIcon" id="Element_and_ModifIcon_NomProject">
            {ConfigEdition(edit.edit_NomProject,
                <div className="auth__form-container_fields-content_input" id={""}>
                    <input
                        ...
                        onKeyUp={event => event.key === "Enter" ? setEdit({...edit, edit_NomProject: !edit.edit_NomProject}) : null}
                        required
                    />
                </div>
                ,
                <h1 className="h1_big"><strong>Project:</strong> {infosProjet.NomProject}</h1>
            )}
            {modifIcon("edit_NomProject",
        ...
        <div className="drop-downMenus">
            ...
            <div className="Element_and_ModifIcon">
                ...
                <img src={edit.edit_Visibility? ValidationIcon: EditElementIcon}
                     alt={"Modify Item"}
                     className="icon_edit"
                     onClick={() => {setEdit({...edit, edit_Visibility: !edit.edit_Visibility});
        ...
        <div className="Element_and_ModifIcon">
            <Form.Group className="mb-3  auth__form-container_fields-content_input"
            ...
            {modifIcon("edit_DescriptionProject",
        ...
        <div className="auth__form-container_fields-content_button">
            <button type="button" className="button_CurrProj" id={"button_CurrProj_dissolve"}>Dissolve</button>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button type="button" className="button_CurrProj">Join</button>
        </div>
    </>;
}
